          ...
          <div class="navbar-header">
            ...
            <div class="list-inline-item logout">                  
             <a id="logout" href="login.html" class="nav-link">
              <span class="d-none d-sm-inline">Logout </span><i class="icon-logout"></i></a></div>
          </div>
        </div>
      </nav>
    </header>
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          <li class="active"><a href="Masyarakat.php"> <i class="icon-dashboard"></i>Home </a></li>
          <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-padnote"></i> Pengaduan </a>
            <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
              <li><a href="?url=tulis_pengaduan">Tulis</a></li>
              <li><a href="?url=lihat_pengaduan">Tampil Data</a></li>
            </ul>
          </li>
      </nav>
       <div class="page-content">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Tulis Pengaduan</h2>
          </div>
        </div>
        <!-- Breadcrumb-->
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                <div class="block">
                  ...
                  <div class="block-body">
                    <form class="form-horizontal" action="simpan_pengaduan.php">
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Tanggal Pengaduan</label>
                        <div class="col-sm-9">
                      ...
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Tulis Laporan</label>
                        <div class="col-sm-9">
                      ...
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Unggah Foto</label>
                        <div class="col-sm-9">
                          <input type="file" name="foto" class="form-control" accept=".jpg, .jpeg, .png, .gif"><small class="help-block-none">*tipe yang bisa di upload adalah : .jpg, .jpeg, .png, .gif</small>
                        </div>
                      </div>
                      <div class="line"></div>
                      <div class="form-group row">
